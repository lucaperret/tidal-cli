...
exports.PLAYLIST_PREVIEW_HTML = exports.LIBRARY_INSIGHTS_HTML = exports.RESOURCE_MIME = exports.PLAYLIST_PREVIEW_URI = exports.LIBRARY_INSIGHTS_URI = void 0;
exports.registerCurationResources = registerCurationResources;
exports.LIBRARY_INSIGHTS_URI = 'ui://tidal/library-insights';
exports.PLAYLIST_PREVIEW_URI = 'ui://tidal/playlist-preview';
// Apps SDK resource MIME type (verified against developers.openai.com/apps-sdk).
exports.RESOURCE_MIME = 'text/html;profile=mcp-app';
...
`;
function doc(title, body, script) {
...
`;
exports.LIBRARY_INSIGHTS_HTML = doc('Tidal Library Insights', '', LIBRARY_INSIGHTS_SCRIPT);
exports.PLAYLIST_PREVIEW_HTML = doc('Tidal Playlist Preview', '', PLAYLIST_PREVIEW_SCRIPT);
/** Register the UI component resources. Harmless on non-ChatGPT clients (they never fetch them). */
function registerCurationResources(server) {
    server.registerResource('tidal-library-insights', exports.LIBRARY_INSIGHTS_URI, { title: 'Tidal Library Insights', description: 'Interactive view of a Tidal library analysis', mimeType: exports.RESOURCE_MIME }, async (uri) => ({ contents: [{ uri: uri.href ?? exports.LIBRARY_INSIGHTS_URI, mimeType: exports.RESOURCE_MIME, text: exports.LIBRARY_INSIGHTS_HTML }] }));
    server.registerResource('tidal-playlist-preview', exports.PLAYLIST_PREVIEW_URI, { title: 'Tidal Playlist Preview', description: 'Editable playlist preview with Save to Tidal', mimeType: exports.RESOURCE_MIME }, async (uri) => ({ contents: [{ uri: uri.href ?? exports.PLAYLIST_PREVIEW_URI, mimeType: exports.RESOURCE_MIME, text: exports.PLAYLIST_PREVIEW_HTML }] }));
}
